...
with st.sidebar:
    ...
    #linha com texto
    st.write("""
    - **Abaixo do pesso**: IMC menor que 18.5       
...
#entrada de dado - peso e altura
peso = st.number_input(label="Digite o seu peso (em kg)", min_value=0.0, step=0.10, format="%.1f")
altura = st.number_input(label="Digite a sua altura (em metros)" , min_value=0.0, step=0.10, format="%.1f")
